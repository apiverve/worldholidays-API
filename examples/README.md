# World Holidays API - Examples

This folder contains example code for using the World Holidays API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/worldholidays',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/worldholidays");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/worldholidays](https://docs.apiverve.com/ref/worldholidays)
