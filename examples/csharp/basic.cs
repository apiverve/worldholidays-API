...
{
    class WorldHolidaysExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/worldholidays";

        /// <summary>
        /// Make a GET request to the World Holidays API
        /// </summary>
        static async Task<JsonDocument> CallWorldHolidaysAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;country&quot;] &#x3D; &quot;US&quot;, [&quot;year&quot;] &#x3D; 2025 };
        ...
        {
            Console.WriteLine("📤 Calling World Holidays API...\n");

            var result = await CallWorldHolidaysAPI();
