...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/worldholidays',
        'Source': 'https://github.com/apiverve/worldholidays-api',
        'Bug Tracker': 'https://github.com/apiverve/worldholidays-api/issues'
    },
    classifiers=[
