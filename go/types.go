// Package worldholidays provides a Go client for the World Holidays API.
//
// For more information, visit: https://apiverve.com/marketplace/worldholidays?utm_source=go&utm_medium=readme
package worldholidays
...
// Request contains the parameters for the World Holidays API.
//
// Parameters:
//   - country (required): string - The 2-letter country code for which you want to get the holidays [minLength: 2, maxLength: 2]
//   - year: integer - The year for which you want to get the holidays [min: 2000, max: 2050]
type Request struct {
...
// ResponseData contains the data returned by the World Holidays API.
type ResponseData struct {
	Country string `json:"country"`
	Year string `json:"year"`
	Holidays []HolidaysItem `json:"holidays"`
}

// HolidaysItem represents an item in the Holidays array.
