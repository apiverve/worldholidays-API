...
```gradle
dependencies {
    implementation 'com.github.apiverve:worldholidays-api:1.1.12'
}
```
...
```java
import com.apiverve.worldholidays.WorldHolidaysAPIClient;
import com.apiverve.worldholidays.APIResponse;
import com.apiverve.worldholidays.APIException;

// Initialize the client
WorldHolidaysAPIClient client = new WorldHolidaysAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/worldholidays](https://docs.apiverve.com/ref/worldholidays)
...
- **Documentation:** [https://docs.apiverve.com/ref/worldholidays](https://docs.apiverve.com/ref/worldholidays)
- **Issues:** [GitHub Issues](https://github.com/apiverve/worldholidays-api/issues)
