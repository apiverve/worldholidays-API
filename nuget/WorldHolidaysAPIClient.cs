...
namespace APIVerve.API.WorldHolidays
{
    ...
    /// <summary>
    /// Client for the WorldHolidays API
    /// </summary>
    public class WorldHolidaysAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/worldholidays";
        ...
        public WorldHolidaysAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WorldHolidaysAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public WorldHolidaysAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, WorldHolidaysQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(WorldHolidaysQueryOptions options)
        {
        ...
        public ResponseObj Execute(WorldHolidaysQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(WorldHolidaysQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(WorldHolidaysQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(WorldHolidaysQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(WorldHolidaysQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(WorldHolidaysQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(WorldHolidaysQueryOptions options)
        {
