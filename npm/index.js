...
class worldholidaysWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/worldholidays');
        }
        ...
        this.baseURL = 'https://api.apiverve.com/v1/worldholidays';

        // Validation rules for parameters (generated from schema)
        this.validationRules = {"country":{"type":"string","required":true,"minLength":2,"maxLength":2},"year":{"type":"integer","required":false,"min":2000,"max":2050,"default":2026}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/worldholidays`);
        }
    }
...
module.exports = worldholidaysWrapper;
